          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><input class="switch" category-id="{{$category->id}}" type="checkbox" data-on="Aktif" data-offstyle="danger" data-onstyle="success" data-off="Pasif" @if($category->status==1) checked @endif data-toggle="toggle"></td>
                <td>
...
<div class="modal" id="deleteModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button id="removeButton" type="button" class="btn btn-danger" data-dismiss="modal">Kapat</button>
  ...
  <script>
    $(function() {
      $('.remove-click').click(function(){
        ...
        $('#body').hide();
        if (count == 0) {
          $('#articleAlert').html('Bu kategoriye Ait Makale Bulunmuyor. Yine de silmek istiyor musunuz?');
          $('#body').show();
        }
        if (count>0) {
          $('#articleAlert').html('Bu kategoriye ait ' + count + ' makale bulunmaktadır. Silmek istediğinize eminmisiniz.')
          $('#body').show();
        }
        $('#deleteModal').modal();
      });
