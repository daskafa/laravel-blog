        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input class="switch" article-id="{{$article->id}}" type="checkbox" data-on="Aktif" data-offstyle="danger" data-onstyle="success" data-off="Pasif" @if($article->status==1) checked @endif data-toggle="toggle"></td>
              <td>
