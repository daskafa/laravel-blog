...
class ArticleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $request->image->move(public_path('uploads'), $imageName); // public_path projedeki public klasörüne giriş yapılıyor
    ...
    {
        $article = Article::findOrFail($id); // findorfail ile öyle bir data bulamazsa 404 sayfasına yönlendirilir.
    ...
    public function recover($id)
    {
        ...
        toastr()->success('Makale başarıyla geri alındı.');
